...
def main():
    ...
    server_base_url = config.base_server.server_base_url
    if server_base_url:
        asyncio.run(load_skill_schemas(server_base_url))
    else:
        LOG.warning("未配置 base_server.server_base_url，跳过 skill 加载，AI 将不具备 skill 获取能力")
