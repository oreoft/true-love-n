         ...
         "properties": {
             "type": {
                 ...
                 "description": "the type of question, "
                                ...
                                "if user latest question contains [carry-img] and wants you to analyze images "
                                "please return the 'analyze-img', when not included [carry-img],Do not return this type"
