         ...
         "properties": {
             "type": {
                 ...
                 "description": "the type of question, "
                                ...
                                "if user latest question contains [carry-img]"
                                "and wants you to analyze images and need you to comment on the images, "
                                "please return the 'analyze-img'(Do not return this if not included [carry-img])"
